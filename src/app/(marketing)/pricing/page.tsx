...
const tiers = [
  {
    ...
    price: '$2,000',
    period: '/year',
    description: 'For SmallSat startups and university research teams getting started with thermal analysis.',
    features: [
      '5 projects',
  ...
  },
  {
    ...
    price: '$5,000',
    period: '/year',
    description: 'For NewSpace engineers and growing teams who need unlimited capability.',
    features: [
      'Unlimited projects',
      'Unlimited simulations',
      'All export formats (CSV, JSON, HDF5)',
      '3D CAD model import',
      'V&V benchmark suite',
      'Priority support',
  ...
  },
  {
    ...
    price: 'Custom',
    period: '',
    description: 'For organizations and agencies requiring dedicated infrastructure and support.',
    features: [
