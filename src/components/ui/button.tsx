  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer',
  {
    variants: {
      variant: {
        ...
        glow: 'bg-tc-accent text-white font-mono uppercase tracking-wider hover:shadow-[0_0_30px_rgba(var(--tc-accent-rgb),0.4)] hover:scale-[1.02] active:scale-[0.98]',
        'glow-orange': 'bg-tc-accent text-white font-mono uppercase tracking-wider hover:shadow-[0_0_30px_rgba(var(--tc-accent-rgb),0.4)] hover:scale-[1.02] active:scale-[0.98]',
      },
      size: {
